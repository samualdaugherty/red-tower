              ...
              <div className="flex flex-col gap-2.5 items-end w-full">
                <div className="w-full max-w-4xl ml-auto">
                  <p className="font-body text-base md:text-lg lg:text-xl leading-[1.5] text-fg font-light">
                    We've designed and built a comical amount of sites and apps over the years, across dozens of different industries. All built with love and caffeine. Below are some of our most recents, and a couple favorites.
                  </p>
                </div>
              </div>
            </div>
