              ...
              <div className="flex flex-col gap-2.5 items-end w-full">
                <div className="w-full max-w-4xl ml-auto">
                  <p className="font-body text-base md:text-lg lg:text-xl leading-[1.5] text-fg font-light">
                    Together, we can bring your ideas to life. The first step of any project is the initial contact. Use the form below to get started. Drop us a message, and let&apos;s start building something amazing. Together.
                  </p>
                </div>
              </div>
            </div>
