...
export function DIYGuideHero() {
  ...
  // Calculate slow scroll (25% speed)
        ...
        <section className="relative flex flex-col h-screen">
          ...
          >
            ...
            <div 
              ...
              style={{
                background: 'linear-gradient(180deg, #0A0A0A 0%, rgba(10, 10, 10, 0.50) 25.06%, #0A0A0A 100%)',
              }}
            />
          </div>
          ...
          >
            ...
            <div className="relative flex flex-col gap-5 md:gap-[21px] w-full px-6 md:px-8 lg:px-12">
              {/* Heading */}
              ...
              {/* Content - Right aligned with left padding (matching Figma layout) */}
              <div className="flex flex-col gap-2.5 items-end w-full">
                <div className="w-full max-w-4xl ml-auto pl-0">
                  <p className="font-body text-base md:text-lg lg:text-[20px] leading-[1.5] text-fg font-light">
                    Technology has come a long way and made a lot of things easier. But easier doesn&apos;t always mean actually easy. Before you dive into Squarespace or Wix, take a minute to see what&apos;s actually required to make a site live, secure, and functional. This checklist breaks down every hidden task that eats your time—from template tweaks to DNS configuration—so you can plan realistically or hand it off confidently.
                  </p>
                </div>
              </div>
            </div>
